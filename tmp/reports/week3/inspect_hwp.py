...
src=Path('other_documents/2026-2학기__010_최정흠_주간학습보고서_3주차.hwp')
...
for e in entries:
 ...
 if e['name'].startswith('Section'):
  ...
  Path('tmp/reports/week3/records.json').write_text(json.dumps([(t,l,d.hex()) for t,l,d in records]),encoding='utf8')
